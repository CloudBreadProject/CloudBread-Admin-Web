...
namespace CloudBreadAdminWeb.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public ActionResult GetHDAUChartImage()
        {
            ...
            {
                var data = db.StatsData.SqlQuery("select top 24 * from StatsData where CategoryName like 'HDAU' order by CreatedAt asc");
        ...
        public ActionResult GetCashItemChartImage()
        {
            ...
            using (var db = new CloudBreadDBAdminEntities())
            {
                var data = db.StatsData.SqlQuery("select top 30 * from StatsData where CategoryName like 'CASHITEM' order by CreatedAt asc");
